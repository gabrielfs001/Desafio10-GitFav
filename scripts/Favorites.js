...
export class Favorites {
    constructor( root ) {
        ...
        GithubUser.search('gabrielfs001').then( user => console.log(user) );
    }
...
export class FavoritesView extends Favorites {
    ...
    createRow() {
        // É necessário que o elemento HTML <tr> seja criado pela DOM.
        const tr = document.createElement('tr');

        // Depois podemos colocar o template literals como inner html.        
        tr.innerHTML = `
        <td class="user">
            <img src="-" alt="-">
    ...
    createUserTable() {
        this.entries.forEach( user => {
            ...
            row.querySelector('.removeButton').textContent = `Remover`;
